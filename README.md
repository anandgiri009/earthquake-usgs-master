...
Then, just browse to [mlocal.earthquake.usgs.gov](http://mlocal.earthquake.usgs.gov) and you are ready to start developing!
...
Remember to put all domains you're going to hit in your etc/hosts or to run your server with the `-auto-hosts=true` option.
    ...
    127.0.0.1   mlocal.earthquake.usgs.gov
